...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.MenuBar","com.vaadin.ui.Window","com.vaadin.ui.Button","com.vaadin.ui.TabSheet","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.VerticalLayout","com.vaadin.ui.TreeTable","com.vaadin.ui.CustomComponent","com.vaadin.ui.OptionGroup","com.vaadin.ui.ListSelect","com.vaadin.ui.GridLayout","com.vaadin.ui.Tree","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.BrowserFrame","com.vaadin.server.FileDownloader","com.vaadin.ui.TextArea","com.vaadin.ui.CheckBox","com.vaadin.ui.Flash","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.PopupView","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Panel","com.vaadin.ui.NativeButton","com.vaadin.ui.Table","com.vaadin.ui.CustomLayout","com.vaadin.ui.JavaScript","com.vaadin.ui.InlineDateField","com.vaadin.ui.PasswordField","com.vaadin.ui.DateField","com.vaadin.ui.Link","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.NativeSelect","com.vaadin.ui.Form","com.vaadin.ui.Video","com.vaadin.ui.DragAndDropWrapper","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Embedded","com.vaadin.ui.TwinColSelect","com.vaadin.ui.CustomField","com.vaadin.ui.Label","com.vaadin.ui.ProgressBar","com.vaadin.ui.ComboBox","com.vaadin.ui.Upload","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.Slider","com.vaadin.ui.Image","com.vaadin.ui.Accordion","com.vaadin.ui.FormLayout","com.vaadin.ui.CssLayout","com.vaadin.ui.TextField","com.vaadin.ui.Audio","com.vaadin.ui.UI","com.vaadin.ui.AbsoluteLayout",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"id", "description", "height", "primaryStyleName", "errorMessage", "styles", "tabIndex", "modified", "inputPrompt", "required", "hideErrors", "immediate", "resources", "width", "readOnly", "enabled", "caption", "maxLength", "registeredEventListeners", "columns", "text", "propertyReadOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"name", "dayNames", "shortMonthNames", "am", "dateFormat", "firstDayOfWeek", "pm", "hourMinuteDelimiter", "twelveHourClock", "shortDayNames", "monthNames", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"description", "id", "enabled", "height", "width", "readOnly", "resources", "immediate", "caption", "styles", "registeredEventListeners", "errorMessage", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"resources", "description", "modified", "width", "id", "hideErrors", "tabIndex", "caption", "enabled", "primaryStyleName", "propertyReadOnly", "immediate", "required", "errorMessage", "readOnly", "height", "registeredEventListeners", "styles", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"resources", "width", "caption", "primaryStyleName", "readOnly", "id", "marginsBitmask", "immediate", "errorMessage", "description", "height", "styles", "registeredEventListeners", "enabled", "childData", "spacing", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"marginsBitmask", "id", "childData", "spacing", "readOnly", "resources", "enabled", "immediate", "width", "errorMessage", "caption", "height", "description", "registeredEventListeners", "styles", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeX", "ctrlKey", "altKey", "relativeY", "type", "shiftKey", "metaKey", "clientY", "clientX", "button", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"hideErrors", "tabIndex", "styles", "required", "propertyReadOnly", "description", "height", "modified", "registeredEventListeners", "primaryStyleName", "id", "width", "enabled", "resources", "errorMessage", "immediate", "caption", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"errorMessage", "registeredEventListeners", "modified", "primaryStyleName", "rangeStart", "tabIndex", "id", "readOnly", "textFieldEnabled", "width", "required", "caption", "rangeEnd", "immediate", "resources", "styles", "height", "hideErrors", "description", "propertyReadOnly", "descriptionForAssistiveDevices", "enabled", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"immediate", "height", "enabled", "marginsBitmask", "id", "childData", "registeredEventListeners", "styles", "resources", "width", "primaryStyleName", "description", "readOnly", "errorMessage", "spacing", "caption", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"registeredEventListeners", "enabled", "resources", "rpcInterfaces", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"registeredEventListeners", "id", "caption", "parameters", "readOnly", "width", "height", "resources", "immediate", "description", "styles", "target", "features", "errorMessage", "primaryStyleName", "uriFragment", "enabled", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"parameters", "mode", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"registeredEventListeners", "styles", "columns", "primaryStyleName", "readOnly", "id", "required", "modified", "width", "description", "rows", "inputPrompt", "wordwrap", "maxLength", "caption", "enabled", "hideErrors", "text", "propertyReadOnly", "resources", "height", "errorMessage", "immediate", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"altText", "registeredEventListeners", "height", "htmlContentAllowed", "caption", "showControls", "sourceTypes", "primaryStyleName", "errorMessage", "width", "enabled", "autoplay", "styles", "sources", "readOnly", "muted", "description", "resources", "id", "immediate", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"resources", "required", "readOnly", "height", "modified", "registeredEventListeners", "immediate", "propertyReadOnly", "width", "errorMessage", "hideErrors", "styles", "primaryStyleName", "caption", "enabled", "tabIndex", "id", "description", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "row1", "row2", "column1", "column2", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"description", "footer", "immediate", "readOnly", "width", "primaryStyleName", "id", "layout", "tabIndex", "propertyReadOnly", "height", "resources", "required", "caption", "registeredEventListeners", "hideErrors", "enabled", "errorMessage", "styles", "modified", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"primaryStyleName", "immediate", "hideErrors", "width", "readOnly", "styles", "height", "caption", "required", "tabIndex", "registeredEventListeners", "enabled", "modified", "description", "resources", "id", "checked", "propertyReadOnly", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"height", "readOnly", "enabled", "styles", "errorMessage", "firstChild", "id", "resources", "registeredEventListeners", "immediate", "primaryStyleName", "secondChild", "width", "description", "caption", "splitterState", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"enabled", "description", "modified", "height", "immediate", "registeredEventListeners", "readOnly", "caption", "hideErrors", "width", "primaryStyleName", "resources", "propertyReadOnly", "tabIndex", "errorMessage", "styles", "required", "id", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"enabled", "caption", "styles", "id", "registeredEventListeners", "height", "iconAltText", "clickShortcutKeyCode", "htmlContentAllowed", "description", "resources", "errorMessage", "tabIndex", "immediate", "primaryStyleName", "width", "readOnly", "disableOnClick", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"id", "text", "enabled", "height", "styles", "errorMessage", "registeredEventListeners", "immediate", "caption", "width", "description", "primaryStyleName", "resources", "readOnly", "contentMode", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"resources", "styles", "height", "errorMessage", "enabled", "alternateText", "readOnly", "width", "description", "primaryStyleName", "id", "immediate", "caption", "registeredEventListeners", });
            ...
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LoadingIndicatorConfigurationState.class, new String[] {"firstDelay", "thirdDelay", "secondDelay", });
            store.setProperties(java.util.Date.class, new String[] {"year", "hours", "month", "minutes", "seconds", "time", "date", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"enabled", "primaryStyleName", "pageState", "errorMessage", "pushConfiguration", "loadingIndicatorConfiguration", "registeredEventListeners", "tabIndex", "height", "width", "styles", "localeServiceState", "id", "caption", "pollInterval", "resources", "immediate", "tooltipConfiguration", "description", "overlayContainerLabel", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"readOnly", "width", "enabled", "errorMessage", "resources", "immediate", "primaryStyleName", "styles", "caption", "height", "id", "registeredEventListeners", "description", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"primaryStyleName", "registeredEventListeners", "resources", "description", "rpcInterfaces", "enabled", "readOnly", "caption", "callbackNames", "width", "styles", "errorMessage", "immediate", "id", "height", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"height", "readOnly", "caption", "errorMessage", "styles", "required", "resources", "enabled", "registeredEventListeners", "description", "hideErrors", "modified", "propertyReadOnly", "id", "tabIndex", "width", "primaryStyleName", "immediate", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"enabled", "width", "errorMessage", "readOnly", "alternateText", "resources", "description", "caption", "immediate", "primaryStyleName", "registeredEventListeners", "styles", "id", "height", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"state", "propertyReadOnly", "errorMessage", "caption", "hideErrors", "required", "description", "registeredEventListeners", "primaryStyleName", "width", "readOnly", "height", "id", "indeterminate", "tabIndex", "enabled", "styles", "immediate", "resources", "modified", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"required", "enabled", "resources", "errorMessage", "caption", "immediate", "registeredEventListeners", "propertyReadOnly", "indeterminate", "height", "state", "id", "width", "modified", "tabIndex", "description", "primaryStyleName", "hideErrors", "pollingInterval", "readOnly", "styles", });
            ...
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"resizable", "height", "immediate", "description", "resizeLazy", "enabled", "centered", "scrollLeft", "errorMessage", "id", "primaryStyleName", "readOnly", "styles", "caption", "draggable", "scrollTop", "modal", "tabIndex", "width", "windowMode", "positionY", "positionX", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"errorMessage", "width", "codetype", "resources", "immediate", "caption", "embedParams", "enabled", "styles", "classId", "primaryStyleName", "standby", "readOnly", "codebase", "registeredEventListeners", "description", "archive", "id", "alternateText", "height", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"resources", "height", "readOnly", "immediate", "styles", "primaryStyleName", "registeredEventListeners", "width", "errorMessage", "enabled", "description", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"height", "resources", "width", "readOnly", "styles", "errorMessage", "enabled", "templateContents", "registeredEventListeners", "childLocations", "primaryStyleName", "immediate", "description", "id", "templateName", "caption", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"quickOpenDelay", "maxWidth", "quickOpenTimeout", "closeTimeout", "openDelay", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"enabled", "caption", "width", "disableOnClick", "styles", "resources", "height", "iconAltText", "readOnly", "errorMessage", "immediate", "registeredEventListeners", "primaryStyleName", "tabIndex", "description", "clickShortcutKeyCode", "id", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"styles", "resources", "required", "hideErrors", "tabIndex", "width", "errorMessage", "readOnly", "immediate", "id", "caption", "primaryStyleName", "height", "enabled", "registeredEventListeners", "modified", "description", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"scrollTop", "resources", "errorMessage", "primaryStyleName", "description", "caption", "registeredEventListeners", "readOnly", "immediate", "id", "styles", "scrollLeft", "width", "enabled", "tabIndex", "height", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"minPositionUnit", "positionReversed", "maxPositionUnit", "maxPosition", "minPosition", "locked", "positionUnit", "position", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"tabIndex", "height", "readOnly", "registeredEventListeners", "id", "width", "caption", "description", "styles", "primaryStyleName", "errorMessage", "immediate", "resources", "enabled", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"primaryStyleName", "id", "height", "enabled", "required", "registeredEventListeners", "hideErrors", "tabIndex", "readOnly", "modified", "styles", "errorMessage", "rangeStart", "propertyReadOnly", "resources", "rangeEnd", "width", "description", "caption", "immediate", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"registeredEventListeners", "primaryStyleName", "description", "resources", "readOnly", "caption", "height", "immediate", "styles", "enabled", "connectorToCssPosition", "id", "errorMessage", "width", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"propertyReadOnly", "readOnly", "styles", "primaryStyleName", "id", "errorMessage", "resources", "hideErrors", "registeredEventListeners", "height", "immediate", "description", "width", "caption", "enabled", "modified", "tabIndex", "required", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"rows", "readOnly", "errorMessage", "registeredEventListeners", "styles", "primaryStyleName", "width", "resources", "description", "enabled", "columns", "childData", "height", "spacing", "immediate", "caption", "marginsBitmask", "id", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"readOnly", "enabled", "immediate", "resources", "description", "primaryStyleName", "html", "height", "errorMessage", "caption", "hideOnMouseOut", "id", "styles", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"description", "resources", "errorMessage", "immediate", "height", "alternateText", "primaryStyleName", "caption", "registeredEventListeners", "width", "readOnly", "id", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"enabled", "styles", "description", "width", "caption", "height", "primaryStyleName", "errorMessage", "resources", "registeredEventListeners", "childCss", "id", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"width", "description", "registeredEventListeners", "id", "resolution", "orientation", "hideErrors", "tabIndex", "maxValue", "required", "primaryStyleName", "value", "resources", "caption", "modified", "immediate", "readOnly", "enabled", "propertyReadOnly", "errorMessage", "height", "minValue", "styles", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"splitterState", "resources", "primaryStyleName", "id", "registeredEventListeners", "description", "secondChild", "errorMessage", "firstChild", "readOnly", "height", "width", "enabled", "immediate", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"showControls", "primaryStyleName", "sourceTypes", "readOnly", "resources", "enabled", "registeredEventListeners", "muted", "caption", "width", "altText", "styles", "htmlContentAllowed", "autoplay", "immediate", "height", "sources", "description", "errorMessage", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"dayOfWeek", "localizedDateFormat", "week", "date", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"dateFrom", "styleName", "description", "dateTo", "timeTo", "index", "allDay", "timeFrom", "caption", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"endDate", "actionKey", "iconKey", "startDate", "caption", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"primaryStyleName", "format24H", "description", "immediate", "dayNames", "events", "actions", "firstHourOfDay", "resources", "enabled", "readOnly", "styles", "firstVisibleDayOfWeek", "height", "monthNames", "scroll", "now", "lastVisibleDayOfWeek", "errorMessage", "id", "lastHourOfDay", "days", "width", "registeredEventListeners", "caption", "firstDayOfWeek", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"readOnly", "immediate", "caption", "bgColor", "enabled", "width", "primaryStyleName", "resources", "cursorX", "height", "errorMessage", "cursorY", "registeredEventListeners", "description", "styles", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"description", "htmlContentAllowed", "enabled", "resources", "registeredEventListeners", "errorMessage", "popupVisible", "height", "styles", "immediate", "color", "caption", "readOnly", "id", "primaryStyleName", "showDefaultCaption", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"resources", "errorMessage", "readOnly", "changedX", "changedY", "width", "caption", "height", "immediate", "id", "enabled", "primaryStyleName", "rowCount", "columnCount", "registeredEventListeners", "changedColor", "styles", "description", });
